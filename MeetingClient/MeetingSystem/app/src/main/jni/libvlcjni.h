...
int vlc_entry__audio_format_neon (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__float32_mixer (int (*)(void *, void *, int, ...), void *);
int vlc_entry__osd_parser (int (*)(void *, void *, int, ...), void *);
...
int vlc_entry__taglib (int (*)(void *, void *, int, ...), void *);
 ...
 vlc_entry__float32_mixer,
 vlc_entry__osd_parser,
 vlc_entry__xml,
 vlc_entry__gnutls,
 vlc_entry__dummy,
 vlc_entry__freetype,
