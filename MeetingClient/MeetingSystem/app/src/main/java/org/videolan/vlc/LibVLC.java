...
public class LibVLC {
    ...
    public native void attachSurface(Surface surface, Activity player, int width, int height);
    public native void attachSurface(Surface surface, Fragment player, int width, int height);	
    //In libvlcjni must call the player.setSurfaceSize method so must overload the fragment type attachSurface native interface
